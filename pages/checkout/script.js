 document.addEventListener("DOMContentLoaded", (event) => {
        ...
        document.getElementById("submit").addEventListener("click", (e) => {
            e.preventDefault();
            const PBFKey = "FLWPUBK-d0a49aea3154648ade2f6b406d512bbf-X"; // paste in the public key from your dashboard here
            ...
            const coin = document.getElementById('abr').value;
        ...
        getpaidSetup({
            ...
            currency: coin,  // Select the currency. leaving it empty defaults to NGN
