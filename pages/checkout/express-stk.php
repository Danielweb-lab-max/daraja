...
$config = array(
    "env"              => "live",
    "BusinessShortCode"=> "948042",
    "key"              => "3MtamBt9iDybZlxb0GIdWGw0J8jrojVq", //Enter your consumer key here
    "secret"           => "Tdwklw99TUaiGe8q", //Enter your consumer secret here
    "username"         => "apitest",
    "TransactionType"  => "CustomerPayBillOnline",
    "passkey"          => "ac59a4606266815643271dc33af8abfc1287b0b4a1150dd93b40c41e1e66f249", //Enter your passkey here
    "CallBackURL"      => "https://66d8-196-109-50-86.eu.ngrok.io/callback.php", //When using localhost, Use Ngrok to forward the response to your Localhost
    "AccountReference" => "Gain",
...
if (isset($_POST['phone_number'])) {
    ...
    $endpoint = ($config['env'] == "live") ? "https://api.safaricom.co.ke/mpesa/stkpush/v1/processrequest" : "https://api.safaricom.co.ke/mpesa/stkpush/v1/processrequest"; 
